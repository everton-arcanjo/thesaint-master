                        ...
                        <div class="login-box bg-white box-shadow pd-30 border-radius-5">
                            ...
                            <h2 class="text-center mb-30">Login</h2>
                                ...
                                <div class="input-group custom input-group-lg">
                                    <input type="text" class="form-control" placeholder="Login" name="usu_login" value="{{old('usu_login')}}">
                                    <div class="input-group-append custom">
                                        <span class="input-group-text"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    </div>
                                </div>
                                <div class="input-group custom input-group-lg">
                                    <input type="password" class="form-control" placeholder="Senha" name="usu_senha" value="{{old('usu_senha')}}">
                                    <div class="input-group-append custom">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            <button type="submit" class="btn btn-outline-dark btn-lg btn-block">Salvar</button>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
