...
<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10 mCustomScrollbar _mCS_3 mCS-autoHide" style="position: relative; overflow: visible;"><div id="mCSB_3" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" tabindex="0" style="max-height: none;"><div id="mCSB_3_container" class="mCSB_container" style="position: relative; top: 0px; left: 0px;" dir="ltr">
    ...
    <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form name="formCor" action="/meta/update/{{$objMeta->mve_id}}" method="post">
                @csrf
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="meta[vendedor]" id="vendedor" required="required">
                            ...
                            @foreach ($listaVendedor as $vendedor)
                                <option @if($objMeta->mve_usu_id == $vendedor->usu_id) selected="selected"  @endif value="{{$vendedor->usu_id}}">{{$vendedor->usu_nome}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group" style="margin-right: 5px">
                        ...
                        <input class="form-control" type="date" name="meta[data_inicio]" id="dataInicio" value="{{$objMeta->mve_data_inicio}}" required="required">
                    </div>

                    <div class="form-group">
                        <label>Data Fim</label> <span style="color: red">*</span>
                        <input class="form-control" type="date" name="meta[data_fim]" id="dataFim" value="{{$objMeta->mve_data_fim}}" required="required">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="meta[valor_meta]" id="valorMeta" value="{{number_format($objMeta->mve_valor_meta, 2, ',', '.')}}" required="required">
                    </div>
