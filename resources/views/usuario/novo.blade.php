...
@endif
    ...
    <div class="min-height-200px">
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            ...
            <form role="form" name="formCliente" action="/usuario/store" method="post" style="margin-top: 20px">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group" style="width: 50%">
                        ...
                        <input type="text" class="form-control" maxlength="50" placeholder="Nome" name="usuario[nome]" id="usuarioNome" required="required" value="{{old('usuario.nome')}}">
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group" style="margin-right: 20px">
                        ...
                        <input type="text" class="form-control" maxlength="18" placeholder="Telefone" name="usuario[telefone]" id="usuarioTelefone" value="{{old('usuario.telefone')}}">
                    </div>

                    <div class="form-group" style="margin-right: 20px">
                        <label>Celular</label> <span style="color: red">*</span>
                        <input type="text" class="form-control" maxlength="18" placeholder="Celular" name="usuario[celular]" id="usuarioCelular" value="{{old('usuario.celular')}}">
                    </div>

                    <div class="form-group" style="margin-right: 20px;width: 400px">
                        <label>E-mail</label> <span style="color: red">*</span>
                        <input type="text" class="form-control"  maxlength="50" placeholder="E-mail" name="usuario[email]" id="usuarioEmail" required="required" value="{{old('usuario.email')}}">
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group" style="margin-right: 20px">
                        ...
                        <input type="text" class="form-control" maxlength="20" placeholder="Login" name="usuario[login]" id="usuarioLogin" required="required" value="{{old('usuario.login')}}">
                    </div>

                    <div class="form-group" style="margin-right: 20px">
                        <label>Senha</label> <span style="color: red">*</span>
                        <input type="password" class="form-control" maxlength="20" placeholder="Senha" name="usuario[senha]" id="usuarioSenha" required="required" value="{{old('usuario.senha')}}">
                    </div>
