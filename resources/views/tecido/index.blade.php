                            ...
                            <div class="col-sm-12">
                                <nav aria-label="breadcrumb" role="navigation">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" style="color: black;font-weight: bold">Relação de Tecidos</a></li>
                                    </ol>
                                </nav>
                            </div>
            ...
            <div class="pd-10 bg-white border-radius-4 box-shadow mb-10">
                ...
                <form action="/tecido" >
                    <div class="form-inline">
                        ...
                        <input type="text" class="form-control" style="margin-right: 15px" name="tecido" id="tecido "placeholder="Tecido">
                        <button type="submit" class="btn btn-dark" style="margin-right: 15px">Buscar</button>
                        <a href="/tecido/create" class="btn btn-dark">
                        ...
                        <table class="data-table stripe hover nowrap dataTable no-footer dtr-inline table-dark" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="table-plus datatable-nosort" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1">Unidade</th>
                                    <th class="datatable-nosort sorting_disabled" rowspan="1" colspan="1" aria-label="Action">Ações</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($listaTecido as $chave => $tecido)
                                    <tr role="row"  @if($chave%2 == '0') class="odd" @else class="even" @endif style="color: #000">
                                        <td>{{$tecido->tec_tecido}}</td>
                                        <td>{{exibeUnidade($tecido->tec_unidade)}}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="/tecido/edit/{{$tecido->tec_id}}"><i class="fa fa-pencil"></i>Editar</a>
                                                    <a class="dropdown-item" href="/tecido/destroy/{{$tecido->tec_id}}"><i class="fa fa-trash"></i>Deletar</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-5">
                        <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">
                                {{$listaTecido->currentPage()}}-{{$listaTecido->lastPage()}} de {{$listaTecido->count()}} registros
                        </div>
                        </div>
                        <div class="col-sm-12 col-md-7">
                            <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                                {{$listaTecido->appends($_GET)->links()}}
                            </div>
                        </div>
                    </div>
                </div>
