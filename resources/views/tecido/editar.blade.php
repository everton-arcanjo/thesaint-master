...
<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10 mCustomScrollbar _mCS_3 mCS-autoHide" style="position: relative; overflow: visible;"><div id="mCSB_3" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside" tabindex="0" style="max-height: none;"><div id="mCSB_3_container" class="mCSB_container" style="position: relative; top: 0px; left: 0px;" dir="ltr">
    ...
    <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form role="form" name="formTecido" action="/tecido/update/{{ $objTecido->tec_id }}" method="post" style="margin-top: 20px">
                    @csrf
                    <div class="form-group">
                        <label>Tecido</label> <span style="color: red">*</span>
                        <input type="text" class="form-control" maxlength="50" placeholder="Tecido" name="tecido[tecido]" id="tecidoTecido" value="{{ $objTecido->tec_tecido }}" required="required">
                    </div>

                    <div class="form-group">
                        <label>Unidade</label> <span style="color: red">*</span>
                        <select name="tecido[unidade]" class="form-control" id="unidade" required="required">
                            <option value="">Selecione</option>
                            <option @if($objTecido->tec_unidade == 'MT') selected="selected" @endif value="MT">Metros</option>
                            <option @if($objTecido->tec_unidade == 'GR') selected="selected" @endif value="GR">Gramas</option>
                            <option @if($objTecido->tec_unidade == 'KG') selected="selected" @endif value="KG">Kilo</option>
                        </select>
                    </div>
